  ...
  return (
    <main className="legal-page">
      <article>
        ...
        <p>Goals to Today는 연간·분기 계획을 실행 일정과 기록으로 관리하기 위해 필요한 정보만 처리하며, 광고 추적이나 개인정보 판매를 하지 않습니다.</p>
        <h2>처리하는 정보와 목적</h2>
        <ul>
        ...
        <p><Link to="/today">Goals to Today로 돌아가기</Link></p>
      </article>
    </main>
  );
}
  ...
  return (
    <main className="legal-page">
      <article>
        ...
        <p className="legal-page__updated">시행일: 2026년 9월 1일 · 정책 버전 2026-09-01</p>
        <h2>서비스</h2>
        <p>Goals to Today는 목표, 작업, 시간 블록, 실행 기록, 회고를 관리하고 사용자가 선택하면 외부 캘린더와 알림을 연결하는 도구입니다.</p>
        <h2>계정과 이용자의 책임</h2>
        <p>이용자는 본인 계정을 안전하게 관리하고 적법한 내용만 저장해야 합니다. 타인의 권리를 침해하거나 서비스 안정성을 해치는 자동화·공격·우회 사용은 허용되지 않습니다.</p>
        <h2>데이터와 외부 연동</h2>
        <p>저장한 콘텐츠의 권리는 이용자에게 있습니다. Google 캘린더 등 외부 서비스의 장애·정책 변경은 Goals to Today가 통제할 수 없으며, 중요한 일정은 원본 서비스에서도 확인해야 합니다.</p>
        <h2>변경·중단과 책임 범위</h2>
